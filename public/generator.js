...
function timerLog() {
  ...
  function scrollToScore() {
    // Score inputs are inside the workout modal
    var si = document.getElementById('scoreInputs');
    if (si) si.scrollIntoView({ behavior: 'smooth' });
    if (ftTime) {
      // FT: auto-fill total time field (key='workout')
